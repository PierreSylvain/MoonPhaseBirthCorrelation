...
if __name__ == "__main__":
    ...
    # Group the DataFrame by moon phase and calculate the average number of
    # births for each phase
    mean_births_per_moon_phase = df.groupby("moon_phase")[
        "MS_NUM_BIRTHS"].mean()
    ...
    # Perform an Analysis of Variance (ANOVA) to test if the average number of
    # births differs significantly across the different moon phases
